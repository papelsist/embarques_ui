...
const BuscadorEnvioParcial = ({onCloseDialog,mostrarDialog, setRowSelection,onOpenDialogInstruccion}) => {
    ...
    const buscar = async()=>{
        ...
        const url = `${apiUrl.url}embarques/get_envio_parcial/`
    ...
    const handleInstruccion = ()=>{
        if(!envio){
            return
        }
        onCloseDialog()
        onOpenDialogInstruccion()
    }
        ...
        <Box sx={{width:"30rem"}}>
            ...
            <Grid container spacing={2} padding={1}>
                ...
                <Tooltip title="Instruccion">
                    <IconButton onClick={handleInstruccion}>
                        <PieChartIcon />
                    </IconButton>
                </Tooltip>
                </Grid>
...
export default BuscadorEnvioParcial;
